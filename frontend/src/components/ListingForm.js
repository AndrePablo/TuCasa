      ...
      <div className="row">
        <div className="col-1-of-6">
          <div className="listingform__section">
            <label className="listingform__label" htmlFor="sale_choice">
              Sale or Rent
            </label>
            <select
        ...
        <div className="col-1-of-6">
          <div className="listingform__section">
            <label className="listingform__label" htmlFor="houseType">
              Home Type
            </label>
            <select
              className="listingform__select"
        ...
        <div className="col-1-of-6">
          <div className="listingform__section">
            <label className="listingform__label" htmlFor="baths">
              Baths
            </label>
            <select
              className="listingform__select"
          ...
          <div className="listingform__altsection">
            <label className="listingform__label" htmlFor="openHouse">
              Open Houses
            </label>
            <input
